...
CREDIT_TEXT_POS = (10, 1030)
QUIT_TEXT_RECT = pyg.Rect(PLAY_BTN_POS[0], 1030, PLAY_BTN_SIZE[0], 40)
...
EOL_TITLE_POS = (EOL_BG_X + (EOL_BG_WIDTH - 644) / 2, 40)

POINTS_TEXT_RECT = pyg.Rect(EOL_BG_X, 420 - 30, EOL_BG_WIDTH, 65)
...
EOG_TEXT4_RECT = pyg.Rect(637, 1030, 556, 40)
...
CELL_SELECT_ANIMATION = 1
CELL_TEMP_SELECT_ANIMATION = 2
CELL_TOUCH_ANIMATION = 3

CELL_TOUCH_ANIMATION_MIN_INTENSITY = 3
CELL_TOUCH_ANIMATION_MAX_INTENSITY = 10
