...
# Main menu
LOGO_SIZE = (1000, 400)
LOGO_POS = ((WIDTH - LOGO_SIZE[0]) / 2, 75)
...
# Volume buttons
VOLUME_BTN_X = 20
VOLUME_BTN_SIZE = (100, 100)
VOLUME_TEXT_SIZE = 40
VOLUME_TEXT_COLOR = (25, 25, 25)
MUSIC_VOLUME_TEXT_POS = (VOLUME_BTN_X, HEIGHT - 280)
MUSIC_VOLUME_BTN_POS = (VOLUME_BTN_X, MUSIC_VOLUME_TEXT_POS[1] + VOLUME_TEXT_SIZE - 10)
MUSIC_VOLUME_BTN_RECT = pyg.Rect(*MUSIC_VOLUME_BTN_POS, *VOLUME_BTN_SIZE)
SFX_VOLUME_TEXT_POS = (VOLUME_BTN_X, MUSIC_VOLUME_TEXT_POS[1] + 35 + VOLUME_BTN_SIZE[1])
SFX_VOLUME_BTN_POS = (VOLUME_BTN_X, SFX_VOLUME_TEXT_POS[1] + VOLUME_TEXT_SIZE - 10)
SFX_VOLUME_BTN_RECT = pyg.Rect(*SFX_VOLUME_BTN_POS, *VOLUME_BTN_SIZE)
