...
RESTART_LEVEL_BTN_POS = (EOL_BG_X + MEDAL_X, MEDAL_TEXT_Y + MEDAL_TEXT_FONT_SIZE + 100)
...
NEXT_LEVEL_BTN_POS = (EOL_BG_X + MEDAL_X + 40 + RESTART_LEVEL_BTN_SIZE, MEDAL_TEXT_Y + MEDAL_TEXT_FONT_SIZE + 100)
