...
HOLD_TEXT_RECT_1 = pyg.Rect(HOLD_BTN_POS[0] - OPTION_TEXT_BTN_GAP, HOLD_BTN_POS[1] + 15, 0, 40)
HOLD_TEXT_RECT_2 = pyg.Rect(HOLD_BTN_POS[0] - OPTION_TEXT_BTN_GAP, HOLD_BTN_POS[1] + 45, 0, 40)

# Levels
LEVEL_COUNT = 2

LEVEL_TITLE_RECT = pyg.Rect(0, 0, WIDTH, 120)
